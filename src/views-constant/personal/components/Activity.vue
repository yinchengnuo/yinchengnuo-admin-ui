  ...
  <div class="user-activity">
    <div class="post">
      <div class="user-block">
        ...
        <span class="description">发布动态 - 7:30 上午 今天</span>
      </div>
      <p>我bai就是钢铁侠</p>
    ...
    <div class="post">
      <div class="user-block">
        ...
        <span class="description">给你发了 1 条消息 - 昨天</span>
      </div>
      <p>我可以跟你耗上整一天！</p>
      <ul class="list-inline">
        <li>
    ...
    <div class="post">
      <div class="user-block">
        ...
        <span class="username">蛛蛛侠</span>
        <span class="description">上传了 4 张照片 - 2 天以前</span>
      </div>
